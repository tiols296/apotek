...
(2, 'admin', 'admin', 'Mugia Meitiawati');
...
(30, 'A0003', 1, '8kj3caw6isex1rtkl7d29bqhusabp8im3e81d0t6'),
(31, 'D0001', 2, '8kj3caw6isex1rtkl7d29bqhusabp8im3e81d0t6'),
(32, 'A0001', 1, 'ddhz7y9d862qs6oltawuqguztyldn2ic654mo0gd');
...
('I3V356K', '1630511078', 20000, '2019-12-30', 'L', '2019-12-30'),
...
--
ALTER TABLE `detail_pemesanan`
  ADD CONSTRAINT `detail_pemesanan_ibfk_1` FOREIGN KEY (`kode_obat`) REFERENCES `obat` (`kode_obat`),
  ADD CONSTRAINT `detail_pemesanan_ibfk_2` FOREIGN KEY (`kode_pesan`) REFERENCES `pemesanan` (`kode_pesan`);
COMMIT;
